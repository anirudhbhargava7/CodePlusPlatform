...
<div id="page-wrap"> 
<?php 
$my_input = $_SESSION['email']."/"."input".".txt";
//i have reassigned the variable...to work concatenation MAGIC :-D.
$lever = fopen($my_input, 'w') or die('Cannot open file:  '.$my_input);
fwrite($lever, $input);
$my_file = $_SESSION['email']."/".$file.".c";
//i have reassigned the variable...to work concatenation MAGIC :-D.
$fileo=$_SESSION['email']."/".$file;
$handle = fopen($my_file, 'w') or die('Cannot open file:  '.$my_file);
fwrite($handle, $code);
$inputc=$_SESSION['email']."/"."input.txt";
$outputc=$_SESSION['email']."/"."output.txt";
$logc=$_SESSION['email']."/"."log.txt";
