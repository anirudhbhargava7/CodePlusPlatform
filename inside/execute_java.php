...
<div id="page-wrap"> 
<?php 
$my_input = "GUEST_JAVA/input".".txt";//i have reassigned the variable...to work concatenation MAGIC :-D.
$lever = fopen($my_input, 'w') or die('Cannot open file:  '.$my_input);
fwrite($lever, $input);
$my_file = "GUEST_JAVA/$file".".java";//i have reassigned the variable...to work concatenation MAGIC :-D.
$fileo="GUEST_JAVA/$file";
$handle = fopen($my_file, 'w') or die('Cannot open file:  '.$my_file);
fwrite($handle, $code);
$inputc="GUEST_JAVA/input.txt";
$outputc="GUEST_JAVA/output.txt";
$logc="GUEST_JAVA/log.txt";
$run="java -cp GUEST_JAVA '$file'";
$runin="java -cp GUEST_JAVA $file<$inputc>$outputc";
