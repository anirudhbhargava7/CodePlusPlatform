...
<div id="page-wrap"> 
<?php 
$my_input = "GUEST_C/input".".txt";//i have reassigned the variable...to work concatenation MAGIC :-D.
$lever = fopen($my_input, 'w') or die('Cannot open file:  '.$my_input);
fwrite($lever, $input);
$my_file = "GUEST_C/$file".".c";//i have reassigned the variable...to work concatenation MAGIC :-D.
$fileo="GUEST_C/$file";
$handle = fopen($my_file, 'w') or die('Cannot open file:  '.$my_file);
fwrite($handle, $code);
$inputc="GUEST_C/input.txt";
$outputc="GUEST_C/output.txt";
$logc="GUEST_C/log.txt";
$run="timeout 3 ./$file>$outputc";
$runin="timeout 3 ./$fileo<$inputc>$outputc";
$cmd="gcc $my_file 2> $logc -o $fileo";
system($cmd,$retc);
if(!$retc){
if($input=="NULL"){
system($run,$reto);
